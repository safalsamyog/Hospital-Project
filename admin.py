...
img=PhotoImage(file='icon_images/prof1.png')
...
img1=PhotoImage(file='ic/h22.png')
...
img2=PhotoImage(file='ic/an1.png')
...
img4=PhotoImage(file='ic/ext1.png')
